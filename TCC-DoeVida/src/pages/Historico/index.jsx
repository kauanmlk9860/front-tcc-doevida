    ...
    <div className="historico-container">
      ...
      <header className="historico-header">
        <div className="historico-header-content">
          <div className="header-brand-historico">
            <div className="brand-logo-container-historico">
              <img src={logoSemFundo} alt="DoeVida" className="header-logo-historico" />
              <div className="logo-glow-historico"></div>
            </div>
            <h1 className="brand-title-historico">Histórico de Doação</h1>
          </div>
